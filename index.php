...
<head>
    ...
    <!-- Site Metas -->
    <title>AVANE CLOUD KITCHENS</title>
...
<body>
    ...
    <video autoplay muted loop class="banner">
     <source src="./videos/avanehome.mp4" type="video/mp4">
    </video>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <h3>
                        As Avane, we set our mind to reimagine the food delivery through our unique working model, firstly in Turkey,
                        then globally!
                        </h3>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="about-images">
                            <img class="about-main" src="images/about-main.png" alt="About Main Image">
    ...
    <div class="blog-main pad-top-100 parallax">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <h2 class="block-title color-white text-center"> Our Brands </h2>
                    ...
                    <div class="special-box">
                        <div id="owl-demo">
                            <div class="item item-type-zoom">
                                ...
                                <div class="item-img">
                                    <img src="images/cosa.webp" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                ...
                                <div class="item-img">
                                    <img src="images/beppe.webp" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                ...
                                <div class="item-img">
                                    <img src="images/detroit.webp" alt="sp-menu">
                                </div>
                            </div>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                ...
                                <div class="item-img">
                                    <img src="images/nanem.webp" alt="sp-menu">
                                </div>
                            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="tab-menu">
                        <div class="slider slider-nav">
                            ...
                            <div class="tab-title-menu">
                                <h2>A Full-Stack Model </h2>
                                <p> <i class="flaticon-dinner"></i> </p>
                            </div>
                            <div class="tab-title-menu">
                                <h2>Only One Location</h2>
                            ...
                            <div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        ...
                                        <div>
                                            <h4>
                                               Our first secret sauce is operating virtual restaurants, which is designed for only delivery and takeaway. This allows us to minimize our Capex and Opex compared to traditional restaurants.
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="blog-box clearfix">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="images/futured-image-01.webp" alt="" />
                                        <div class="overlay">
                                            <a href=""><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                    <div class="blog-dit">
                                        <p><span>09 JULY, 2021</span></p>
                                        <h2>Franchise Market Turkey</h2>
                                        <h5>Avane Cloud Kitchens Founder Ahmet Orhon is in Franchise Market Turkey magazine!</h5>
                                    </div>
                                </div>
                            </div>
                            <!-- end col -->
                        ...
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="images/futured-image-02.webp" alt="" />
                                        <div class="overlay">
                                            <a href=""><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                    <div class="blog-dit">
                                        <p><span>6 July, 2021</span></p>
                                        <h2>Local multi-brand cloud kitchen project:Avane Cloud Kitchens</h2>
                                        <h5>BY Webrazzi</h5>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="blog-btn-v">
                        <a class="hvr-underline-from-center" href="#">View the News</a>
                    </div>
        ...
        <div class="footer-box pad-top-70">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-c">
                                ...
                                <p>
                                    ...
                                    <span>Acıbadem, Sarayardı Cd. No:52, 34718 Kadıköy/İstanbul</span>
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <span><a href="#">info@avanecloudkitchens.com</a></span>
                                </p>
                            </div>
                            <!-- end footer-box-c -->
                        </div>
            ...
            <div id="copyright" class="copyright-main">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h6 class="copy-title"> Designed by Cyberarp <a href="#" target="_blank"></a> </h6>
                        </div>
                    </div>
                    <!-- end row -->
                </div>
